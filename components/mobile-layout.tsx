...
export default function MobileLayout({ openWindow, windows, closeWindow, bringToFront }: MobileLayoutProps) {
  return (
    <div className="h-full w-full overflow-hidden">
      {/* Mobile Content - Fits inside iPhone frame */}
      <div className="h-full w-full bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 rounded-[47px] overflow-hidden relative">
        {/* Notch Space */}
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
          <div className="bg-white/20 backdrop-blur-md rounded-2xl border border-white/10 p-2">
